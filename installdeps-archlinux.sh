...
then
    ...
    then
        ...
        echo -e "There was an error installing sshfs! The installer will now abort!"
        logger -t superbackup_installer "Package sshfs not installed due to an error, exiting..."
        exit
    fi
fi
echo -ne "Checking for sshfs: Please wait...       \r"
